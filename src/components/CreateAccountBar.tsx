...
const FLOAT_LEFT: FloatLogo[] = [
  {
    ...
    className:
      'absolute left-[2%] top-[10%] w-[2.6rem] sm:left-[12%] sm:top-[6%] sm:w-[3.75rem] md:left-[14%] md:w-[4.25rem] -rotate-[20deg]',
    delay: 0,
    duration: 4.2,
  },
  {
    ...
    className:
      'absolute hidden sm:block left-[18%] top-[44%] w-[3rem] sm:left-[24%] sm:top-[40%] sm:w-[3.5rem] md:left-[26%] md:w-16 rotate-[12deg]',
    delay: 0.6,
    duration: 5,
  },
  {
    ...
    className:
      'absolute left-[2%] bottom-[10%] w-[2.5rem] sm:left-[16%] sm:bottom-[8%] sm:w-[3.25rem] md:left-[18%] rotate-[-8deg]',
    delay: 1.1,
    duration: 4.6,
  },
  {
    ...
    className:
      'absolute hidden sm:block left-[28%] top-[14%] w-[2.5rem] sm:left-[34%] sm:top-[12%] sm:w-12 md:left-[36%] md:w-14 rotate-[18deg]',
    delay: 0.3,
    duration: 5.4,
  },
];
...
const FLOAT_RIGHT: FloatLogo[] = [
  {
    ...
    className:
      'absolute right-[2%] top-[12%] w-[2.2rem] sm:right-[14%] sm:top-[10%] sm:w-11 md:right-[16%] md:w-12 -rotate-[14deg]',
    delay: 0.2,
    duration: 4.8,
  },
  {
    ...
    className:
      'absolute hidden sm:block right-[18%] top-[38%] w-[2.85rem] sm:right-[24%] sm:top-[34%] sm:w-[3.25rem] md:right-[26%] md:w-14 rotate-[16deg]',
    delay: 0.9,
    duration: 5.2,
  },
  {
    ...
    className:
      'absolute right-[2%] bottom-[10%] w-[2.5rem] sm:right-[16%] sm:bottom-[10%] sm:w-[3.5rem] md:right-[18%] rotate-[-12deg]',
    delay: 0.5,
    duration: 4.4,
  },
  {
    ...
    className:
      'absolute hidden sm:block right-[28%] top-[8%] w-[3.1rem] sm:right-[34%] sm:top-[6%] sm:w-[3.6rem] md:right-[36%] md:w-[4rem] rotate-[22deg]',
    delay: 0,
    duration: 5.6,
    whiteHalo: true,
  },
...
export const CreateAccountBar = () => (
  <section className="relative overflow-x-clip border-y border-primary bg-black py-10 sm:py-11 lg:py-12">
    <div
      ...
      aria-hidden
    >
      <div className="absolute inset-y-0 left-0 w-[40%] max-w-[min(100%,220px)] sm:w-[46%] sm:max-w-[340px] md:max-w-[380px]">
        <div className="relative h-full min-h-[inherit]">
          <FloatingLogoCluster items={FLOAT_LEFT} />
        </div>
      </div>
      <div className="absolute inset-y-0 right-0 w-[40%] max-w-[min(100%,220px)] sm:w-[46%] sm:max-w-[340px] md:max-w-[380px]">
        <div className="relative h-full min-h-[inherit]">
